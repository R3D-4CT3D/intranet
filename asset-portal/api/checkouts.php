<?php
/**
 * CSUN Asset Portal - Checkouts API
...
$dataFile = __DIR__ . '/../data/checkouts.json';
...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    if (file_exists($dataFile)) {
        ...
        echo json_encode([
            'checkouts' => [],
            'borrowerTypes' => ['Faculty', 'Staff', 'Student', 'Guest'],
            'checkoutStatuses' => ['Active', 'Returned', 'Overdue', 'Lost']
        ]);
    }
